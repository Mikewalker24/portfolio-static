...
export default class ProjectTemplate extends React.Component {
  ...
  render() {
    ...
    const heroImage = hasSizes ? getImageData(acf.project_image) : { src: acf.project_image.source_url }
            ...
            <div className="container">
              <div className="content">
                ...
                <div className="credit-container">
                  ...
                  <p>
                    Visit the
                    <a href={acf.project_url} target="_blank">live site</a>
                  </p>

                  <p>
                    Design by
                    <a href="http://www.coryingwersen.com/" target="_blank">CORY INGWERSEN</a>
                  </p>
                ...
                { acf.quote_text 
                  ? (
                    <div className="quote-container">
                      ...
                      <div className="lines">
                        <img src="https://mikewalker.co/wp-content/uploads/2017/06/quotes.png" alt="quote-icon" />
                      </div>
